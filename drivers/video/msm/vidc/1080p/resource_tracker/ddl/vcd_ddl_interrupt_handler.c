	...
	struct ddl_client_context *ddl)
{
	...
	if (!ddl->decoding ||
		...
		if (decoder->codec.codec == VCD_CODEC_H264 &&
			seq_hdr_info.level > VIDC_1080P_H264_LEVEL5) {
	...
	u32 level_codec)
{
	...
	break;
	case VIDC_1080P_H264_LEVEL4p1:
		*level = VCD_LEVEL_H264_4p1;
	break;
	case VIDC_1080P_H264_LEVEL4p2:
		*level = VCD_LEVEL_H264_4p2;
	break;
	case VIDC_1080P_H264_LEVEL5:
		*level = VCD_LEVEL_H264_5;
	break;
